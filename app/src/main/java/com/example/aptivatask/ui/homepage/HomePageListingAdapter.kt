...
class HomePageListingAdapter(val context: Context, private var pokemonList: ListingItemResponse) :
    RecyclerView.Adapter<MainViewHolder>() {
    fun setListingData(pokemonlis: ListingItemResponse) {
        this.pokemonList = pokemonlis
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        val listing = pokemonList.results.get(position)
